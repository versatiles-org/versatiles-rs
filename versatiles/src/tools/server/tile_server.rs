...
mod tests {
	...
	async fn server() {
		...
		let meta = "{\"bounds\":[-180,-79.17133464081944,45,66.51326044311185],\"maxzoom\":3,\"minzoom\":2,\"tile_content\":\"vector\",\"tile_format\":\"mvt\",\"tile_schema\":\"other\",\"tilejson\":\"3.0.0\",\"tiles\":[\"/tiles/cheese/{z}/{x}/{y}\"],\"type\":\"dummy\"}";
