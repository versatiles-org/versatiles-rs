...
mod tests {
	...
	async fn server() {
		...
		let meta = "{\"bounds\":[-180,-79.17133464081944,45,66.51326044311185],\"format\":\"mvt\",\"maxzoom\":3,\"minzoom\":2,\"name\":\"cheese\",\"tilejson\":\"3.0.0\",\"tiles\":[\"/tiles/cheese/{z}/{x}/{y}\"],\"type\":\"vector\"}";
