...
- **`sftp`** (default): SFTP support for reading and writing tiles on remote servers
...
- `.tar` - TAR archives
- Tile directories
- SFTP remote destinations (`sftp://[user[:pass]@]host[:port]/path`, requires the `sftp` feature)
