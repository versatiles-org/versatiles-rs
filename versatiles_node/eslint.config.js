...
export default tseslint.config(
	...
	// Files to ignore
	{
		ignores: [
			...
			'index.d.cts', // Type definitions for index.cjs
			'index.js', // Auto-generated by napi-rs
			'index.cjs', // CommonJS entry point
			'vpl.js', // Auto-generated from vpl.ts
			'vpl.d.ts', // Auto-generated from vpl.ts
			'src/vpl.ts', // Auto-generated by generate-vpl.ts
