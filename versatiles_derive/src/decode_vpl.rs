...
const TYPE_MAPPINGS: &[TypeMapping] = &[
	...
	// Where the data is. `FilePath` refuses a URL, which each of its arguments
	// already refused on `to_path_buf` — after building. `SourceLocation`
	// refuses nothing, because a container may live anywhere, and carries the
	// distinction its doc comment used to carry alone (#260).
	TypeMapping {
		pattern: "FilePath",
		display_name: "path",
		method_name: "property_enum_required",
		is_required: true,
		generic_param: Some("FilePath"),
		generic_param2: None,
		is_enum: false,
		has_bounds: false,
		parsed_from: ParsedFrom::Str,
	...
	TypeMapping {
		...
		method_name: "property_enum_required",
		is_required: true,
		generic_param: Some("SourceLocation"),
		generic_param2: None,
		is_enum: false,
		has_bounds: false,
		parsed_from: ParsedFrom::Str,
	...
	TypeMapping {
		...
		method_name: "property_enum_required",
		is_required: true,
		generic_param: Some("RegexPattern"),
		generic_param2: None,
		is_enum: false,
		has_bounds: false,
		parsed_from: ParsedFrom::Str,
	...
	TypeMapping {
		pattern: "CelExpression",
		display_name: "CEL expression",
		method_name: "property_enum_required",
		is_required: true,
		generic_param: Some("CelExpression"),
		generic_param2: None,
		is_enum: false,
		has_bounds: false,
		parsed_from: ParsedFrom::Str,
	...
	TypeMapping {
		pattern: "H3Resolution",
		display_name: "0-15",
		method_name: "property_enum_required",
		is_required: true,
		generic_param: Some("H3Resolution"),
		generic_param2: None,
		is_enum: false,
		has_bounds: true,
		parsed_from: ParsedFrom::Str,
