...
cargo instruments -t "CPU Profiler" --bin versatiles --all-features -- convert --bbox 5.63,48.93,11.24,45.08 --min-zoom 14 http://localhost:8080/planet-latest.versatiles ./tmp/temp.versatiles
